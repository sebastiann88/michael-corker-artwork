  ...
  <>
		<div id="accordionExample" className="row">
			<div className="col-sm-6 col-md-6">
				<div className="rounded-none acc-border border-l-0 border-r-0 border-t-0 dark:border-neutral-600 dark:bg-neutral-800">
					<h2 className="mb-0" id="headingOne">
						<button
							className={`${
								activeElement === "element1" &&
								` [box-shadow:inset_0_-1px_0_rgba(229,231,235)] dark:!-400 dark:[box-shadow:inset_0_-1px_0_rgba(75,85,99)]`
			...
			<div className="rounded-none acc-border border-l-0 border-r-0 border-t-0 border-neutral-200 dark:border-neutral-600 dark:bg-neutral-800">
			...
			<div className="rounded-none acc-border border-b-0 border-l-0 border-r-0 border-t-0 border-neutral-200 dark:border-neutral-600 dark:bg-neutral-800">
		...
		<div className="col-sm-6 col-md-6">
			<div className="rounded-none acc-border border-b-0 border-l-0 border-r-0 border-t-0 border-neutral-200 dark:border-neutral-600 dark:bg-neutral-800">
				...
				>
					<div className="px-5 py-4">
						<strong>This is the forth item's accordion body.</strong> Lorem
						ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum eu
						rhoncus purus, vitae tincidunt nibh. Vivamus elementum egestas
						ligula in varius. Proin ac erat pretium, ultricies leo at, cursus
						ante. Pellentesque at odio euismod, mattis urna ac, accumsan metus.
				...
				<div className="rounded-none acc-border border-b-0 border-l-0 border-r-0 border-t-0 border-neutral-200 dark:border-neutral-600 dark:bg-neutral-800">
					...
					>
						<div className="px-5 py-4">
							<strong>This is the sixth item's accordion body.</strong> Lorem
							ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum eu
							rhoncus purus, vitae tincidunt nibh. Vivamus elementum egestas
							ligula in varius. Proin ac erat pretium, ultricies leo at, cursus
							ante. Pellentesque at odio euismod, mattis urna ac, accumsan metus.
